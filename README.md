...
- Graceful recording output shutdown reduces the chance of truncated final MP4 fragments.
- Built-in performance telemetry and a QA benchmark harness for measuring capture overhead.
